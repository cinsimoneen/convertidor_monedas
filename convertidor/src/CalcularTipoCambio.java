...
//Calcula los valores usando los tipos de cambio obtenidos por la API
public class CalcularTipoCambio {
    ...
    public CalcularTipoCambio(ConsultaApi conversion) {
    ...
    public void guardarValores(String monedaBase, String monedaObjetivo){
    ...
    public void guardarValoresPersonalizados(){
        ...
        System.out.println("Ingrese la moneda base a 3 letras");
        this.monedaBase = lectura.next();
        System.out.println("Ingrese la moneda destino a 3 letras");
